...
이 약관은 또닥또닥 (이하 '회사' 라고 합니다)가 제공하는 제반 상담플러스(이하 '서비스' 라고 합니다)의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
3. 회사가 제공하는 서비스의 내용은 다음과 같습니다.
    1. 심리상담 센터 및 심리상담사에 대한 정보 제공
    2. 심리상담 프로그램에 대한 정보 제공
    3. 개인 맞춤 심리상담사 추천 서비스
    4. 심리상담 신청서 작성 및 상담 문의 서비스
...
본 약관은 2024.01.03부터 시행됩니다.`;

export const PRIVACY = `**제1조(목적)**

또닥또닥(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 상담플러스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
...
1. 필수 수집 정보: 이메일 주소, 비밀번호, 닉네임, 생년월일 및 휴대폰 번호
...
1. 회사는 개인정보 제3자 제공 금지에도 불구하고, 이용자가 사전에 공개하거나 다음 각호 사항에 대하여 동의한 경우에는 제3자에게 개인정보를 제공할 수 있습니다. 다만 이 경우에도 회사는 관련 법령 내에서 최소한으로 개인정보를 제공합니다.
    1. 이용자가 서비스 이용을 위하여 선택, 요청한 제휴업체 및 개인에게 심리상담 및 예약 관리을 위하여 닉네임, 연락처, 이메일, ID 등을 포함한 이용자가 직접 작성한 상담신청서 내용을 제공
...
1. 엔에이치엔클라우드(주)에게 본인인증 및 SMS 발송를 위하여 회원 탈퇴 시 혹은 위탁계약 종료 시까지동안 개인정보처리를 위탁함
...
1. 회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보 보호 책임자를 지정하고 있습니다.
    1. 개인정보 보호 책임자
        1. 성명: 정산
        2. 직책: CTO
        3. 전화번호: 010-8934-7286
        4. 이메일: ddodak22@gmail.com
...
제1조 본 방침은 2024.01.03부터 시행됩니다.

**개인정보 수집 및 이용에 대한 안내**

개인정보수집목적]

대도시권 광역 교통위원회는 다음의 목적을 위하여 개인정보를 처리합니다.

처리하고있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용목적이 변경되는 경우에는 개인정보보호법 제18조에따라 별도의 동의를 받는등 필요한 조치를 이행할 예정입니다.

①회원제 서비스 이용에 따른 관리 본인 여부 식별 확인 회원자격 유지 관리를 위한 인증 회원가입 등

②서비스 이용에 따른 마일리지의 산정 및 적립

③원활한 의사소통의 경로 확보 및 분쟁조정을 위한 기록보존 본인의사 확인 고지사항 전달 민원인의 신원 확인 및 불만처리 사실조사를 위한 연락․통지 처리결과 통보 등

④통계학적 분석 및 정책개발 이용자의 서비스 이용에 대한 통계분석 웹로그 분석 등

⑤보안정책 수립 온라인 정보 도용 및 유출사고 예방 사고 조사 등의 목적

[개인정보수집항목]

필수: 아이디,비밀번호,이름,생년월일,성별,가입경로,직업,휴대폰번호,주민등록상 행정구역, 생계급여사실여부, 의료급여사실여부, 주거급여사실여부, 교육급여사실여부, 차상위장애인사실여부, 차상위자활근로대상자사실여부, 차상위본인부담대상자사실여부

[개인정보의보유및이용기간]

**수집된 개인정보는 개인의 탈퇴요청일의 1년 까지 보유 이용됩니다**

[동의를 거부할 권리및동의를 거부할 경우의 불이익사항]

귀하는 개인정보의 수집 이용목적에 대한 동의를 거부할 수 있으며 동의 거부 시 알뜰교통카드 서비스를 이용하실 수 없습니다.`;
